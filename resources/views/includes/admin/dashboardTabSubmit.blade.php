...
<div id="content-5" class="custom-scrollbar-js custom-scrollbar-css">
    ...
    <div class="row">
        ...
        <div class="col-2 border text-center text-capitalize align-middle">{{ $content->usage }}</div>
        ...
        <div class="col-1 border text-center align-middle py-1">    
            ...
            <div class="dropdown-menu dropdown-menu-end text-primary" ari py-4a-labelledby="navbarDropdown">
                <a class="btn btn-primary link-primary dropdown-item" href="{{ url($url.'/preview/'.$content->id . '-' . str_replace(' ', '-', $content->title)) }}"><i class="fa-solid fa-eye"></i> Preview</a>
