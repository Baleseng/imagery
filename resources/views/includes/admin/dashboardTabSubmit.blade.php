<div class="row">
    ...
    <div class="col-2 text-bg-primary text-center">Title</div>

    <div class="col-2 text-bg-primary text-center">Views</div>
    <div class="col-2 text-bg-primary text-center">Likes</div>
    <div class="col-2 text-bg-primary text-center">Posts</div>
...
<div id="content-5" class="custom-scrollbar-js custom-scrollbar-css">
    ...
    <div class="row">
        ...
        <div class="col-2 border text-center align-middle py-1">
        ...
        <div class="col-2 border text-center align-middle">0</div>
        <div class="col-2 border text-center align-middle">0</div>
        <div class="col-2 border text-center align-middle">0</div>
