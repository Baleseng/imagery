<div class="row">
    ...
    <div class="col-2 text-bg-primary text-center">Category</div>
...
<div id="content-5" class="custom-scrollbar-js custom-scrollbar-css">
    ...
    <div class="row">
        ...
        <div class="col-2 border"><p class="text-center align-middle d-block lh-2">{{ $content->file_category }}</p></div>
        <div class="col-2 border"><p class="text-center align-middle d-block lh-2">{{ $content->file_usage }}</p></div>
