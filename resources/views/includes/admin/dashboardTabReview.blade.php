    ...
    <div class="row">
        ...
        <div class="col-3 border text-center align-middle py-4"><a href="">Business Development</a></div>
        <div class="col-2 border text-center align-middle py-4">Review</div>
        ...
        <div class="col-1 border text-center align-middle py-4 px-4">
            ...
            <div class="dropdown-menu dropdown-menu-end" ari py-4a-labelledby="navbarDropdown">
                <a class="dropdown-item" href="{{ url('/creator/edit') }}" role="button" data-bs-toggle="dropdown"><i class="fa-solid fa-pen-to-square"></i> Edit</a>
                <a class="dropdown-item" href="{{ url('/creator/region') }}" role="button" data-bs-toggle="dropdown"><i class="fa-solid fa-earth-africa"></i> Region</a>
                <a class="dropdown-item" href="#" role="button" data-bs-toggle="dropdown"><i class="fa-solid fa-folder-closed"></i> Archive</a>
            </div>
