<h5>Download image</h5>
  ...
  <ul class="list-group rounded-0">
    <li class="list-group-item my-0 border-0">
      <input type="radio" class="btn-check disabled" name="btnGroupRadio" id="btnRadio1" autocomplete="on" checked>
    ...
    <li class="list-group-item my-0 border-0">
      <input type="radio" class="btn-check disabled" name="btnGroupRadio" id="btnRadio2" autocomplete="off">
      <label class="btn btn-outline-secondary col-12" for="btnRadio2">
        ...
        <span class="d-inline-block col-9 text-start">
          ...
          <button class="link link-primary border-0 bg-light disabled" style="font-size:10px;">Read Terms & Condition</button>
        </span>
      </label>
    </li>
  </ul>
