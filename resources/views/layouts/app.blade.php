                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="col-xxl-6 col-xl-6 col-lg-8 col-md-8 col-6 d-flex flex-row-reverse">
                        ...
                        <ul class="list-group list-group-horizontal">
                            <li class="list-group-item text-secondary"><a href="{{ url('/') }}" class="text-secondary"><i class="fa fa-home"></i></a></li>
                            <li class="list-group-item text-secondary"><i class="fa fa-non-sticky"></i></li>
                            <li class="list-group-item text-secondary"><i class="fa fa-user"></i></li>
                            <li class="list-group-item text-secondary dropdown">
