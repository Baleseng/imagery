  ...
  <div class="row">
    <div class="col-lg-8 border" style="max-width:80%;">
      <div class="btn mt-2 mx-auto col-12" role="group" aria-label="Basic outlined button group">
        <span class="btn btn-outline-secondary"><i class="fa-solid fa-heart"></i> Save</span>
        <span class="btn btn-outline-secondary"><i class="fa-solid fa-share"></i> Share</span>
        <span class="btn btn-outline-secondary"><i class="fa-solid fa-download"></i> Try</span>
      </div>
